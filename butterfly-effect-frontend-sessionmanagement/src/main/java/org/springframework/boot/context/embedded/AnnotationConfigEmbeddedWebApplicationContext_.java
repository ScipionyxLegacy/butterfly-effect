...
/**
 * {@link EmbeddedWebApplicationContext} that accepts annotated classes as input
 * - in particular
 * {@link org.springframework.context.annotation.Configuration @Configuration}
 * -annotated classes, but also plain {@link Component @Component} classes and
 * JSR-330 compliant classes using {@code javax.inject} annotations. Allows for
 * registering classes one by one (specifying class names as config location) as
 * well as for classpath scanning (specifying base packages as config location).
 * <p>
 * Note: In case of multiple {@code @Configuration} classes, later {@code @Bean}
 * definitions will override ones defined in earlier loaded files. This can be
 * leveraged to deliberately override certain bean definitions via an extra
 * Configuration class.
 *
 * @author Phillip Webb
 * @see #register(Class...)
 ...
 */
public class AnnotationConfigEmbeddedWebApplicationContext_ extends EmbeddedWebApplicationContext
	...
	private transient final AnnotatedBeanDefinitionReader reader;

	private transient final ClassPathBeanDefinitionScanner scanner;
	 ...
	 */
	public AnnotationConfigEmbeddedWebApplicationContext_() {
	 ...
	 *            classes
	 */
	public AnnotationConfigEmbeddedWebApplicationContext_(Class<?>... annotatedClasses) {
		this();
	 ...
	 */
	public AnnotationConfigEmbeddedWebApplicationContext_(String... basePackages) {
		this();
		scan(basePackages);
		refresh();
	}
