package com.scipionyx.butterflyeffect.frontend.user.ui.view;
...
@MenuConfiguration(position = Position.TOP_RIGHT, label = "User", group = "", order = 99)
public class RootView extends AbstractView {

	public static final String VIEW_NAME = "butterfly-effect-frontend-user:root";
